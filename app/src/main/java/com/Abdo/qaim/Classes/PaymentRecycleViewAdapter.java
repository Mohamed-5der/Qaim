...
import com.Abdo.qaim.Models.PreviwerPayments.DataItem;
...
public class PaymentRecycleViewAdapter extends RecyclerView.Adapter<PaymentRecycleViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Picasso.with(activity).load(details.getCompany().getImage()).fit().into(holder.imageView);
        holder.name.setText(details.getCompany().getName());details.getCompany().getImage();
        holder.price.setText(details.getCost());
