...
public class PreviewerRegisterParms {
    ...
    String identity , identity_docs ;

    public PreviewerRegisterParms(String name, String phone, String email, String password, String country_code, int city_id, int region_1_id, int region_2_id, int region_3_id, String identity, String identity_docs) {
        this.name = name;
        this.phone = phone;
        this.email = email;
