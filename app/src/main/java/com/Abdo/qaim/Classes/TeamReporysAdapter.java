...
import com.Abdo.qaim.Models.MyListTeamReports.Painter;
import com.Abdo.qaim.Models.MyListTeamReports.Previewer;
import com.Abdo.qaim.Models.MyListTeamReports.Reviewer;
import com.Abdo.qaim.Models.MyListTeamReports.Row;
...
//            holder.description.setText(previewer.getEmail());
        ...
        if (reviewer != null){
            ...
            Picasso.with(activity).load(reviewer.getImage()).fit().error(activity.getDrawable(R.drawable.rectangle_4491)).into(holder.imageView);
//            holder.description.setText(previewer.getEmail());
        }
