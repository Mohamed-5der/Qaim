...
public class CustomAttributedAdapter extends RecyclerView.Adapter<CustomAttributedAdapter.ViewHolder>{
    List<AttributesItem> attributesItems ;

    public CustomAttributedAdapter(List<AttributesItem> attributesItems) {
