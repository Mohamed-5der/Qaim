...
public class CustomAttributedAdapterReport extends RecyclerView.Adapter<CustomAttributedAdapterReport.ViewHolder> {
    List<com.qaim.qaim.Models.ShowCompanyPrevReport.AttributesItem> attributesItems ;

    public CustomAttributedAdapterReport(List<com.qaim.qaim.Models.ShowCompanyPrevReport.AttributesItem> attributesItems) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        com.qaim.qaim.Models.ShowCompanyPrevReport.AttributesItem attributesItem = attributesItems.get(position);
