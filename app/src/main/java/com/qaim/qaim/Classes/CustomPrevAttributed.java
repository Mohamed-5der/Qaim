...
import com.qaim.qaim.Models.ShowPrevRealstate.AttributesItem;
import com.qaim.qaim.R;

import java.util.List;

public class CustomPrevAttributed extends RecyclerView.Adapter<CustomPrevAttributed.ViewHolder> {
    List<AttributesItem> attributesItems ;

    public CustomPrevAttributed(List<AttributesItem> attributesItems) {
