...
import com.qaim.qaim.Models.MyListPrevDetails.AttributesItem;
import com.qaim.qaim.R;

import java.util.List;

public class CustomPrevAttributesAdapter extends RecyclerView.Adapter<CustomPrevAttributesAdapter.ViewHolder> {

    List<AttributesItem> attributesItems ;

    public CustomPrevAttributesAdapter(List<AttributesItem> attributesItems) {
