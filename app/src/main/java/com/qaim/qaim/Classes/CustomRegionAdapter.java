...
import com.qaim.qaim.Models.RegionsResponse.CitiesItem;
import com.qaim.qaim.R;

import java.util.List;

public class CustomRegionAdapter extends BaseAdapter {
    List<com.qaim.qaim.Models.RegionsResponse.CitiesItem> citiesItems ;

    public CustomRegionAdapter(List<com.qaim.qaim.Models.RegionsResponse.CitiesItem> citiesItems) {
