...
import com.qaim.qaim.Models.UserReportResponse.AttributesItem;
import com.qaim.qaim.R;

import java.util.List;

public class CustomUserAttributesAdapter extends RecyclerView.Adapter<CustomUserAttributesAdapter.ViewHolder> {

    List<AttributesItem> attributesItems ;

    public CustomUserAttributesAdapter(List<AttributesItem> attributesItems) {
