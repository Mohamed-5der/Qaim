...
import com.qaim.qaim.Models.MyListEmployeeDetails.AttributesItem;
import com.qaim.qaim.R;

import java.util.List;

public class EmpAttributesAdapter extends RecyclerView.Adapter<EmpAttributesAdapter.ViewHolder> {

    List<AttributesItem> attributesItems ;

    public EmpAttributesAdapter(List<AttributesItem> attributesItems) {
