...
import com.qaim.qaim.Classes.PainterListAdapter;
...
public class PainterListFragment extends Fragment {
    ...
    PainterListAdapter adapter ;


    public PainterListFragment() {
        // Required empty public constructor
    }

    public static PainterListFragment newInstance(int param1) {
        PainterListFragment fragment = new PainterListFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_painter_list, container, false);
        ...
        call.enqueue(new Callback<GetTeamListResponse>() {
            ...
            public void onResponse(Call<GetTeamListResponse> call, Response<GetTeamListResponse> response) {
                ...
                if (teamPreviwerListResponse.getCode() == 200) {
                    ...
                    adapter = new PainterListAdapter(teamPreviwerListResponse.getData().getPainters() , mParam1);
