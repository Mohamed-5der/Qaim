...
public class ShowPainterProfileFragment extends Fragment {
    ...
    ImageView imageView ;
    TextView userName1 , userName2 , email , phone ;
    public ShowPainterProfileFragment() {
        // Required empty public constructor
    }


    public static ShowPainterProfileFragment newInstance(String param1, String param2, String param3 , int param4) {
        ShowPainterProfileFragment fragment = new ShowPainterProfileFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        email = v.findViewById(R.id.cost);
