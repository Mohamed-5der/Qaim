...
public class Row{
	...
	@SerializedName("prev_has_report")
	private int previewerHasReport;

	public int getPreviewerHasReport() {
		return previewerHasReport;
	}

	public void setPreviewerHasReport(int previewerHasReport) {
		this.previewerHasReport = previewerHasReport;
	}
