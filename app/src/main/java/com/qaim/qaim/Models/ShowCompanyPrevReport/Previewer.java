...
public class Previewer{
	...
	public void setPreviewerDocument(String previewerDocument){
		this.previewerDocument = previewerDocument;
	}
	...
	public void setPreviewerDoc(String previewerDoc){
		this.previewerDoc = previewerDoc;
	}
	...
	@Override
 	public String toString(){
		return 
			...
			",years = '" + years + '\'' + 
			",token = '" + token + '\'' + 
			",previewer_document = '" + previewerDocument + '\'' + 
			",country_code = '" + countryCode + '\'' + 
			",extra_about = '" + extraAbout + '\'' + 
			",previewer_doc = '" + previewerDoc + '\'' + 
			",phone = '" + phone + '\'' + 
			",name = '" + name + '\'' + 
			",id = '" + id + '\'' + 
			",email = '" + email + '\'' + 
