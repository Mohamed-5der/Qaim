...
public class Row{
	...
	private float previewerRate;

	@SerializedName("previewer_has_rate")
	private int previewer_has_Rate;

	@SerializedName("company_has_rate")
	private int company_has_Rate;

	public int getPreviewer_has_Rate() {
		return previewer_has_Rate;
	}

	public void setPreviewer_has_Rate(int previewer_has_Rate) {
		this.previewer_has_Rate = previewer_has_Rate;
	}

	public int getCompany_has_Rate() {
		return company_has_Rate;
	}

	public void setCompany_has_Rate(int company_has_Rate) {
		this.company_has_Rate = company_has_Rate;
	}
	...
	public void setClientCity(ClientCity clientCity){
	...
	public void setPreviewerRate(float previewerRate){
		this.previewerRate = previewerRate;
	}

	public float getPreviewerRate(){
